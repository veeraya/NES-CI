<div class="content-wrapper">
  <div class="row">
    ...
    <div class="twelve columns">
          <hgroup>
          <h1>NUS Entrepreneurship Society</h1>
          <h2>Entrepreneurship is in our blood.</h2>
          <img src="<?php echo base_url() ?>assets/images/nes.jpg" class="image-border"/>
        </hgroup>
          <p>
            The NUS Entrepreneurship Society (NES) was founded in July 1992 and has since grown to become one of the largest societies in NUS today.
          </p>
